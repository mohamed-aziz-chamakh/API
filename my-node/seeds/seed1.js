exports.seed = function(knex) {
  ...
  return knex('collecte').del()
    ...
    .then(function () {
      // Inserts seed entries for collecte table
      return knex('collecte').insert([
        { sensor_id: 1, gateway_id: 1, mesure: 10.5, taux_erreur: 0.1, unite: 'unit1' },
        { sensor_id: 2, gateway_id: 1, mesure: 20.3, taux_erreur: 0.2, unite: 'unit2' }
      ]);
    });
};
